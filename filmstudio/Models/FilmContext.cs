...
namespace filmstudio.Models
{
    public class FilmContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FilmStudioModel>().HasData(new FilmStudioModel { StudioId = 2, StudioName = "Studio 2" });
            modelBuilder.Entity<FilmStudioModel>().HasData(new FilmStudioModel { StudioId = 3, StudioName = "Studio 3" });
